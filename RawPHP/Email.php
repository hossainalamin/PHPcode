...
<body>
            <?php
            //form required
            $nameerr=$mailerr=$gendererr=$messagerr=$weberr=" ";
            $name=$mail=$message=$gender=$website = " ";
            if($_SERVER['REQUEST_METHOD'] =="POST")
            {
                ...
                elseif(!filter_var($_POST['Email'],FILTER_VALIDATE_EMAIL))
                {
                     ...
                     $mailerr="<span style='color:red'>Invalid mail formate.</span>";
                }
                else{
                ...
                {    
                   $weberr="<span style='color:red'>Invalid website formate.</span>";
                }
                else{
