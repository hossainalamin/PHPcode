...
?>
    <tr>
        ...
        <td>
        <?php echo"<a href='updateteacher.php?action=edit&id=".$value['id']."'>Edit</a>";?> ||
        <?php echo"<a href='deleteteacher.php?action=delete&id=".$value['id']."'onClick='return confirm(\"Are you sure to delete data..\")'>delete</a>";?>
        </td>
    </tr>
<?php } ?>
